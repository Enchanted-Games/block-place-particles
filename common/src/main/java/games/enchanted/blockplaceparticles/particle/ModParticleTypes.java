...
public class ModParticleTypes {
    ...
    public static void registerParticles() {
        ...
        DUST = register((SpriteParticleProviderRegistration) FallingTintedOrAverageDust.RandomisedSizeProvider::new, ResourceLocation.fromNamespaceAndPath(ParticleInteractionsMod.MOD_ID, "dust"), false, BlockParticleOption::codec, BlockParticleOption::streamCodec);
