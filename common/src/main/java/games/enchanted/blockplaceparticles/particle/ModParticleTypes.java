...
import games.enchanted.blockplaceparticles.particle.shatter.AbstractShatter;
...
public class ModParticleTypes {
    ...
    public static ParticleType<BlockParticleOption> ABSTRACT_SHATTER;
    ...
    public static void registerParticles() {
        ...
        ABSTRACT_SHATTER = register((SpriteProviderReg) AbstractShatter.PortalShatterProvider::new, ResourceLocation.fromNamespaceAndPath(ParticleInteractionsMod.MOD_ID, "abstract_shatter"), false, BlockParticleOption::codec, BlockParticleOption::streamCodec);
