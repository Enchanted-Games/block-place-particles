...
public class ConfigScreen {
    public static Screen createConfigScreen(Screen parentScreen) {
        return YetAnotherConfigLib.createBuilder()
            ...
            .title(ConfigTranslation.getConfigTitle())
            .category(ConfigCategory.createBuilder()
                .name(ConfigTranslation.getCategoryName(ConfigTranslation.BLOCKS_CONFIG_CATEGORY))
                .tooltip(ConfigTranslation.createDesc(ConfigTranslation.getCategoryName(ConfigTranslation.BLOCKS_CONFIG_CATEGORY)))

                // block config info
                .group(OptionGroup.createBuilder()
                    .name( ConfigTranslation.getGroupName(ConfigTranslation.BLOCKS_CONFIG_CATEGORY, "info") )
                ...
                .group( createParticleToggleAndMaxConfigGroup(
                    ...
                    maxParticlesOnBreakOption(ConfigTranslation.MAX_PARTICLES_ON_FLUID_BREAK_OPTION, ConfigHandler.maxSnowflakes_onBreak_DEFAULT, () -> ConfigHandler.maxSnowflakes_onBreak, newVal -> ConfigHandler.maxSnowflakes_onBreak = newVal)
                ))
                ...
                .group( createParticleToggleAndMaxConfigGroup(
                    ...
                    maxParticlesOnBreakOption(ConfigTranslation.MAX_PARTICLES_ON_FLUID_BREAK_OPTION, ConfigHandler.maxCherryPetals_onBreak_DEFAULT, () -> ConfigHandler.maxCherryPetals_onBreak, newVal -> ConfigHandler.maxCherryPetals_onBreak = newVal)
                ))
                .group( createBlockItemListOption(
                    Component.literal("Cherry Petal"),
                    "cherry_petal",
                ...
                .group( createParticleToggleAndMaxConfigGroup(
                    ...
                    maxParticlesOnBreakOption(ConfigTranslation.MAX_PARTICLES_ON_FLUID_BREAK_OPTION, ConfigHandler.maxAzaleaLeaves_onBreak_DEFAULT, () -> ConfigHandler.maxAzaleaLeaves_onBreak, newVal -> ConfigHandler.maxAzaleaLeaves_onBreak = newVal)
                ))
                .group( createBlockItemListOption(
                    Component.literal("Azalea Leaf"),
                    "azalea_leaf",
                ...
                .group( createParticleToggleAndMaxConfigGroup(
                    ...
                    maxParticlesOnBreakOption(ConfigTranslation.MAX_PARTICLES_ON_FLUID_BREAK_OPTION, ConfigHandler.maxFloweringAzaleaLeaves_onBreak_DEFAULT, () -> ConfigHandler.maxFloweringAzaleaLeaves_onBreak, newVal -> ConfigHandler.maxFloweringAzaleaLeaves_onBreak = newVal)
                ))
                .group( createBlockItemListOption(
                    Component.literal("Flowering Azalea Leaf"),
                    "flowering_azalea_leaf",
                ...
                .group( createParticleToggleAndMaxConfigGroup(
                    ...
                    maxParticlesOnBreakOption(ConfigTranslation.MAX_PARTICLES_ON_FLUID_BREAK_OPTION, ConfigHandler.maxTintedLeaves_onBreak_DEFAULT, () -> ConfigHandler.maxTintedLeaves_onBreak, newVal -> ConfigHandler.maxTintedLeaves_onBreak = newVal)
                ))
                .group( createBlockItemListOption(
                    Component.literal("Biome Coloured Leaf"),
                    "biome_leaf",
                ...
                .group( createParticleToggleAndMaxConfigGroup(
                    ...
                    maxParticlesOnBreakOption(ConfigTranslation.MAX_PARTICLES_ON_FLUID_BREAK_OPTION, ConfigHandler.maxBlock_onBreak_DEFAULT, () -> ConfigHandler.maxBlock_onBreak, newVal -> ConfigHandler.maxBlock_onBreak = newVal)
                ))

            .build())

            .category(ConfigCategory.createBuilder()
                .name(ConfigTranslation.getCategoryName(ConfigTranslation.FLUIDS_CONFIG_CATEGORY))
                .tooltip(ConfigTranslation.createDesc(ConfigTranslation.getCategoryName(ConfigTranslation.FLUIDS_CONFIG_CATEGORY)))

                // fluid config info
                .group(OptionGroup.createBuilder()
                    .name( ConfigTranslation.getGroupName(ConfigTranslation.FLUIDS_CONFIG_CATEGORY, "info") )
    ...
    private static OptionGroup createFluidParticleToggleAndMaxConfigGroup(Component particleName, String groupName, String category, Binding<Boolean> spawnOnFluidPlaceBinding, Option<Integer> maxPlaceParticlesOption) {
        Component groupNameComponent = ConfigTranslation.getGroupName(category, groupName);
        return OptionGroup.createBuilder()
            .name( ConfigTranslation.createPlaceholder(groupNameComponent, particleName.getString()) )
            .description(OptionDescription.of( ConfigTranslation.createPlaceholder(ConfigTranslation.createDesc(groupNameComponent), particleName.getString()) ))
            .option(Option.<Boolean>createBuilder()
                .name( ConfigTranslation.getGlobalOption("spawn_fluid_particle_on_place") )
    ...
    private static OptionGroup createParticleToggleAndMaxConfigGroup(Component particleName, String groupName, String category, Binding<Boolean> spawnOnBlockPlaceBinding, Option<Integer> maxPlaceParticlesOption, Binding<Boolean> spawnOnBlockBreakBinding, Option<Integer> maxBreakParticlesOption) {
        ...
        return OptionGroup.createBuilder()
            ...
            .description(OptionDescription.of( ConfigTranslation.createPlaceholder(ConfigTranslation.createDesc(groupNameComponent), particleName.getString()) ))
            .option(Option.<Boolean>createBuilder()
                .name( ConfigTranslation.getGlobalOption("spawn_block_particle_on_place") )
            ...
            .option(maxPlaceParticlesOption)
            .option(Option.<Boolean>createBuilder()
                .name( ConfigTranslation.getGlobalOption("spawn_block_particle_on_break") )
    ...
    private static Option<Integer> maxParticlesOnPlaceOption(String optionName, int maxParticlesDefault, Supplier<Integer> getter, Consumer<Integer> setter) {
        return createIntegerOption(maxParticlesDefault, getter, setter, ConfigTranslation.getGlobalOption(optionName), ConfigTranslation.createDesc(ConfigTranslation.getGlobalOption(optionName)), 1, 16, 1);
    }
    private static Option<Integer> maxParticlesOnBreakOption(String optionName, int maxParticlesDefault, Supplier<Integer> getter, Consumer<Integer> setter) {
        return createIntegerOption(maxParticlesDefault, getter, setter, ConfigTranslation.getGlobalOption(optionName), ConfigTranslation.createDesc(ConfigTranslation.getGlobalOption(optionName)), 2, 8, 1);
    }
