...
public class NeoParticleProviderRegistry {
    ...
    private static class PendingProvider<T extends ParticleOptions>  {
        ...
        PIVanillaParticles.SpriteProviderReg<?> pProvider;
        public PendingProvider(ParticleType<T> particleType, PIVanillaParticles.SpriteProviderReg<T> particleProvider) {
            this.pType = particleType;
            this.pProvider = particleProvider;
        }
    }

    public static <T extends ParticleOptions> void registerProviderWhenReady(ParticleType<T> particleType, PIVanillaParticles.SpriteProviderReg<T> particleProvider) {
