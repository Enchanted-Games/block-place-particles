...
public class FallingSpinningParticle extends ParticleInteractionsParticle {
    ...
    protected FallingSpinningParticle(ParticleContext context, ParticleAppearance appearance, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, float gravityMultiplier, boolean transparency) {
        this(context, appearance, x, y, z, xSpeed, ySpeed, zSpeed, gravityMultiplier);
