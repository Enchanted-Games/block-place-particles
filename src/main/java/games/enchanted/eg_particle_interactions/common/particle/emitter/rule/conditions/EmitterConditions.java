...
public class EmitterConditions {
    ...
    static {
        ...
        EMITTER_RULE_TYPES.put(ParticleInteractionsMod.id("entity"), EntityPredicateEmitterCondition.CODEC);
        EMITTER_RULE_TYPES.put(ParticleInteractionsMod.id("light_level"), LightLevelEmitterCondition.CODEC);
        EMITTER_RULE_TYPES.put(ParticleInteractionsMod.id("raw_light"), RawLightEmitterCondition.CODEC);
